 ...
 */
export function createTextElement<T extends HTMLElement>(
	tagName: keyof HTMLElementTagNameMap,
	text: string,
	className?: string
): T {
	const props: any = { textContent: text };
	if (className) {
		props.className = className;
	}
	return createElement<T>(tagName, props);
}
...
export function getElementData<T extends Record<string, unknown>>(
	el: HTMLElement,
	scheme: Record<string, (value: string) => any>
): T {
